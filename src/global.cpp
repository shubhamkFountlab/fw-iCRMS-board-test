...
void SendAnalogOutputToRegisters(uint16_t val)
{
    if (val == 1)
    {
        dac1.setChannelValue(MCP4728_CHANNEL_B, 1024, MCP4728_VREF_INTERNAL, MCP4728_GAIN_1X); // AO 1
        dac1.setChannelValue(MCP4728_CHANNEL_A, 2048, MCP4728_VREF_INTERNAL, MCP4728_GAIN_1X); // AO 2
        dac1.setChannelValue(MCP4728_CHANNEL_D, 3072, MCP4728_VREF_INTERNAL, MCP4728_GAIN_1X); // AO 3
        dac1.setChannelValue(MCP4728_CHANNEL_C, 4094, MCP4728_VREF_INTERNAL, MCP4728_GAIN_1X); // AO 4
    }
    else if (val == 0)
    {
        dac1.setChannelValue(MCP4728_CHANNEL_B, 4094, MCP4728_VREF_INTERNAL, MCP4728_GAIN_1X); // AO 1
        dac1.setChannelValue(MCP4728_CHANNEL_A, 3072, MCP4728_VREF_INTERNAL, MCP4728_GAIN_1X); // AO 2
        dac1.setChannelValue(MCP4728_CHANNEL_D, 2048, MCP4728_VREF_INTERNAL, MCP4728_GAIN_1X); // AO 3
        dac1.setChannelValue(MCP4728_CHANNEL_C, 1024, MCP4728_VREF_INTERNAL, MCP4728_GAIN_1X); // AO 4
    }
}
